{{-- <div class="theme-settings card bg-gray-800 pt-2 collapse" id="theme-settings">
    <div class="card-body bg-gray-800 text-white pt-4">
        ...
        <a href="product/laravel/volt-admin-dashboard-template" target="_blank"
        ...
        <div class="d-flex justify-content-center">
            <a class="me-3" href="product/admin-dashboard/volt-bootstrap-5-dashboard"
                target="_blank">
                <img src="/assets/img/technologies/bootstrap-5-logo.svg" class="image image-xs">
            </a>
            <a href="/volt-react-dashboard/#/" target="_blank">
    ...
    <div class="container">
        <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-12 col-md-4 mb-4 mb-md-0 text-lg-center">
                ...
                <p class="mb-0 text-center">© <span class="current-year"></span>
                    <a class="text-primary fw-normal" target="_blank">Nasari Digital
                    </a>
                </p>
            </div>
        </div>
