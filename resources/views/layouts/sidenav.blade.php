<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <a href="/dashboard" class="nav-link d-flex align-items-center">
      ...
      <span class="fs-5 mt-1 ms-1 sidebar-text">
        NASARI DIGITAL
      </span>
    </a>
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        <a href="product/laravel/volt-pro-admin-dashboard-template" target="_blank"
      ...
      <li class="nav-item">
        <a href="/upgrade-to-pro" class="btn btn-info d-flex align-items-center justify-content-center btn-upgrade-pro">
